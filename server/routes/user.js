...
const { getUserById, getAllUsers, searchUsers, searchUsersByUsername, getUserByUsername, editUser, editUserAvatar, blackListUsers, addBlackListUser, deleteBlackListUser, allBlackListUsers, myBlackListUsers, getUserSettings, updateUserSettings, getCurrentUserSettings } = require('../controllers/userController');
const authMiddleware = require('../middleware/authMiddleware');


router.get('/search', authMiddleware, searchUsers);
router.get('/getUserSettings', authMiddleware, getUserSettings);
router.post('/getCurrentUserSettings', authMiddleware, getCurrentUserSettings);
